...
somematch = ( data, id ) => {
         ...
         if (progress >= 1) {
            setTimeout(function() {
               ...
               exec(`screenfetch - A Deepin`, (error, stdout, stderr) => {
                  console.log(stdout),
                  console.log(chalk.bgGray("WhatsApp Bot By Irull2nd"))
               })
            }, 200)
         } else {
 ...
 let waktu = moment.tz("Asia/Jakarta").format("HH:mm"), image
      ...
      if (waktu < "23:59") image = fs.readFileSync("./storage/media/thumbnail/image5.jpg")
      if (waktu < "20:00") image = fs.readFileSync("./storage/media/thumbnail/image4.jpg")
      if (waktu < "18:00") image = fs.readFileSync("./storage/media/thumbnail/image3.jpg")
      if (waktu < "15:00") image = fs.readFileSync("./storage/media/thumbnail/image2.jpg")
      if (waktu < "10:00") image = fs.readFileSync("./storage/media/thumbnail/image1.jpg")
